...
return static function (ContainerConfigurator $container): void {
    $container
        ->services()
            ...
            ->set('1tomany.llmsdk.action.batch.create', CreateBatchAction::class)
                ->arg('$clientFactory', service('1tomany.llmsdk.factory.client.batch'))
            ->alias(ReadBatchActionInterface::class, service('1tomany.llmsdk.action.batch.read'))
            ->set('1tomany.llmsdk.action.batch.read', ReadBatchAction::class)
                ->arg('$clientFactory', service('1tomany.llmsdk.factory.client.batch'))

            // Batch Clients
            ->set('1tomany.llmsdk.client.gemini.batch', GeminiBatchClient::class)
                ->tag('1tomany.llmsdk.client.batch')
            ->set('1tomany.llmsdk.client.mock.batch', MockBatchClient::class)
                ->tag('1tomany.llmsdk.client.batch')
            ->set('1tomany.llmsdk.client.openai.batch', OpenAIBatchClient::class)
                ->tag('1tomany.llmsdk.client.batch')
